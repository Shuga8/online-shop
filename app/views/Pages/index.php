...
<div class="site-blocks-cover" style="background-image: url('<?php echo SITE_URL; ?>/public/images/hero_1_e.jpg');" data-aos="fade">
  <div class="container">
      ...
      <div class="col-md-12">
        <div class="nonloop-block-3 owl-carousel">
          <div class="item">
            <div class="block-4 text-center">
              <figure class="block-4-image">
                <img src="<?php echo SITE_URL; ?>/public/images/cloth_1.jpg" alt="Image placeholder" class="img-fluid">
              </figure>
          ...
          <div class="item">
            <div class="block-4 text-center">
              <figure class="block-4-image">
                <img src="<?php echo SITE_URL; ?>/public/images/shoe_1.jpg" alt="Image placeholder" class="img-fluid">
              </figure>
              <div class="block-4-text p-4">
                <h3><a href="#">Corater</a></h3>
                <p class="mb-0">Finding perfect products</p>
                <p class="text-primary font-weight-bold">₦9000</p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="block-4 text-center">
              <figure class="block-4-image">
                <img src="<?php echo SITE_URL; ?>/public/images/cloth_2.jpg" alt="Image placeholder" class="img-fluid">
              </figure>
              <div class="block-4-text p-4">
                <h3><a href="#">Polo Shirt</a></h3>
                <p class="mb-0">Finding perfect products</p>
                <p class="text-primary font-weight-bold">₦15000</p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="block-4 text-center">
              <figure class="block-4-image">
                <img src="<?php echo SITE_URL; ?>/public/images/cloth_3.jpg" alt="Image placeholder" class="img-fluid">
              </figure>
              <div class="block-4-text p-4">
                <h3><a href="#">T-Shirt Mockup</a></h3>
                <p class="mb-0">Finding perfect products</p>
                <p class="text-primary font-weight-bold">₦7500</p>
              </div>
            </div>
          </div>
          <div class="item">
  ...
  <div class="container">
    ...
    <div class="row align-items-center">
      <div class="col-md-12 col-lg-7 mb-5">
        <a href="#"><img src="<?php echo SITE_URL; ?>/public/images/blog_1.jpg" alt="Image placeholder" class="img-fluid rounded"></a>
      </div>
