            ...
            <tbody>
              <tr>
                <td class="product-thumbnail">
                  <img src="<?php echo SITE_URL;  ?>/public/images/cloth_1.jpg" alt="Image" class="img-fluid">
                </td>
              ...
              <tr>
                <td class="product-thumbnail">
                  <img src="<?php echo SITE_URL;  ?>/public/images/cloth_2.jpg" alt="Image" class="img-fluid">
                </td>
                <td class="product-name">
